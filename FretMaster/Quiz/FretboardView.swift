...
public struct CompactFretboardView: View {
    ...
    private var openStringMargin: CGFloat { dotRadius * 2 + 6 }
    ...
    private func drawBoard(ctx: GraphicsContext, size: CGSize) {
        ...
        ctx.fill(
            ...
            with: .color(Color(.sRGB, red: 0.20, green: 0.14, blue: 0.07))
        )
        ...
        for s in 0..<stringCount {
            ...
            ctx.stroke(p,
                       with: .color(Color(.sRGB, red: 0.82, green: 0.82, blue: 0.82)),
        ...
        for s in 0..<stringCount {
            ...
            for fret in fretRange {
                ...
                let isTarget = targetQuestion?.note == note
